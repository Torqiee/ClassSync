    ...
    <div class="flex min-h-screen flex-1">
        ...
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-28">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div>
                    <h2 class="mt-6 text-2xl font-semibold leading-9 tracking-tight text-gray-900">Buat akun ClassSync</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-500">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="font-medium text-[#4F46E5] hover:text-indigo-500 transition-colors">Masuk di sini</a>
                    </p>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-8 relative">
                        ...
                        <div class="relative flex justify-center text-sm font-medium leading-6">
                            <span class="bg-white px-6 text-gray-500">Atau daftar instan dengan</span>
                        </div>
                    </div>
        ...
        <div class="relative hidden w-0 flex-1 lg:block bg-cover bg-center bg-no-repeat" 
             style="background-image: url('MASUKKAN_LINK_GAMBAR_PERPUSTAKAAN_KAMU_DI_SINI_ATAU_GAMBAR_LAIN');">
