        ...
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-28">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div>
                    ...
                    <h2 class="mt-1 text-2xl font-semibold leading-9 tracking-tight text-gray-900">Masuk ke akun Anda</h2>
                    <p class="mt-1 text-sm leading-6 text-gray-500">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-medium text-[#4F46E5] hover:text-indigo-500 transition-colors">Daftar sekarang gratis</a>
                    </p>
                </div>
                ...
                <div class="mt-8">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember_me" name="remember" type="checkbox"
                                    class="h-4 w-4 rounded border-gray-300 text-[#4F46E5] focus:ring-[#4F46E5]">
                                <label for="remember_me" class="ml-2 block text-sm leading-6 text-gray-900">Remember me</label>
                            </div>

                            <div class="text-sm leading-6">
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="font-medium text-[#4F46E5] hover:text-indigo-500 transition-colors">Forgot password?</a>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="mt-6">
                        <a href="/auth/google/redirect"
                            class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 transition-all active:scale-[0.98]">
